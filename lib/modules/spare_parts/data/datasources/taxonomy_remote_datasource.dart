...
import '../models/taxonomy_category_model.dart';

class TaxonomyRemoteDataSource {
  final http.Client _client;

  TaxonomyRemoteDataSource({http.Client? client}) : _client = client ?? http.Client();

  Future<List<TaxonomyCategoryModel>> getProductCategories({int page = 1}) async {
    ...
    final uri = Uri.parse('$baseUrl${ApiEndpoints.taxonomy(type: 'product', page: page)}');
    ...
    return const <TaxonomyCategoryModel>[];
  }
