...
class SimulatorBookingTab extends StatefulWidget {
  const SimulatorBookingTab({super.key});

  @override
  State<SimulatorBookingTab> createState() => _SimulatorBookingTabState();
}

class _SimulatorBookingTabState extends State<SimulatorBookingTab> {
  static const int _simulatorBranchId = 2; // simulation car race branch
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!mounted) return;
      context.read<ServiceCubit>().load(locationId: _simulatorBranchId);
    });
  }
                    ...
                    children: [
                      ...
                      BlocBuilder<BranchCubit, BranchState>(
                        builder: (context, branchState) {
                          ...
                          final simulatorBranch = branches.where((b) => b.id == _simulatorBranchId).toList();
                          final branchName = simulatorBranch.isNotEmpty ? simulatorBranch.first.name : 'Simulation Car Race';
                  ...
                  children: [
                    ...
                    SubmitBookingButton(
                      onPressed: () {
                        ...
                        final branches = branchState is BranchSuccess ? branchState.branches : const <Branch>[];
                        final selectedBranch = branches.where((b) => b.id == _simulatorBranchId).toList();
                        ...
                        final args = BookingDetailsArgs(
                          ...
                          locationId: _simulatorBranchId,
                          serviceId: serviceId,
                          bookingNote: note,
                          bookingType: 'simulation',
                        );
