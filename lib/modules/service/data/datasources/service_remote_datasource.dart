...
class ServiceRemoteDataSource {
  ...
  ServiceRemoteDataSource({http.Client? client}) : _client = client ?? http.Client();

  Future<List<ServiceModel>> getServices({required int locationId}) async {
    ...
    final uri = Uri.parse('$baseUrl${ApiEndpoints.services(locationId: locationId)}');
